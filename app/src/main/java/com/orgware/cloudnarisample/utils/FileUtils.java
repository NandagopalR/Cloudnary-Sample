...
/**
 * Created by OrgwareTechnologies on 4/25/16.
 */
public class FileUtils {
  ...
  public static File createAttachmentFile(Context context, String fileName) throws IOException {
  ...
  public static File createAttachmentCacheFile(Context context, String fileName)
      throws IOException {
    File parent = new File(context.getCacheDir(), BuildConfig.UPLOAD_FILES_FOLDER);
    parent.mkdirs();
    File dstFile = new File(parent, fileName);
